...
pub use crate::models::custom_model::Config;
use crate::models::custom_model::RotaryEmbedding;
...
impl Attention {
    ...
    fn forward(
        ...
        let key_states = candle_transformers::utils
            ::repeat_kv(key_states, self.num_kv_groups)?
            .contiguous()?;
        let value_states = candle_transformers::utils
...
impl Model {
    ...
    fn prepare_decoder_attention_mask(
        ...
        mask.expand((b_size, 1, tgt_len, tgt_len + seqlen_offset))?.to_dtype(DType::F32)
    }
